...
function clickListener() {
  ...
  let start_year = parseInt(document.getElementById('min_year').value);
  let end_year = parseInt(document.getElementById('max_year').value);
  let url = `/api/v1.0/${start_year}/${end_year}`;
